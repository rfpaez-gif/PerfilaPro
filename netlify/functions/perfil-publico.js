    ...
    if (!data) {
      return {
        ...
        body: htmlPage({
          ...
          body: `<div style="text-align:center;padding:4rem 1rem;color:var(--color-gris-500)"><h1 style="font-family:var(--font-serif);font-size:1.5rem;font-weight:400;letter-spacing:-0.02em;margin-bottom:.5rem;color:var(--color-tinta)">Perfil no encontrado</h1><p>Este perfil no existe o no está activo.</p></div>`,
          crumbs: null,
          siteUrl,
        }),
      };
