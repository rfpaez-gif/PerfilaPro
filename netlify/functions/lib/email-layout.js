 ...
 * Mantener este mapa SINCRONIZADO con public/styles/tokens-color.css
 * cada vez que cambie la paleta del producto.
 *
 * Los emails usan el sistema general (Tinta + Verde Match sobre
 * Crema). Outlook clásico no renderiza rgba() de forma fiable,
 * por eso inkSoft/border son hex sólidos y NO deben sustituirse
 * por rgba().
 */

const COLORS = {
  bg:         '#FAF7F0',  // Crema           · --color-crema
  surface:    '#FFFFFF',  // tarjetas
  ink:        '#0A1F44',  // texto principal · --color-tinta
  inkSoft:    '#6B7280',  // texto secundario · --color-gris-500
  accent:     '#00C277',  // Verde Match     · --color-verde-match
  accentDeep: '#00A865',  // hover/visited   · --color-verde-dark
  accentSoft: '#E6F9F0',  // bloques destacados · --color-verde-light
  border:     '#E5E7EB',  // separadores     · --color-gris-200

  // Estados
  success:    '#00A865',  // --color-verde-dark
  warning:    '#B8860B',  // TODO: el brief no define un color de warning. Decidir y migrar.
  danger:     '#E5484D',  // --color-coral
};
